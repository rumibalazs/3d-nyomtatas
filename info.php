    ...
    <div class="container pt-5 content">
        <div class="row">
            <div class="info col-12 content">
                <!-- Bevezetés -->
                <h3 class="center padding">Mi a 3D nyomtatás?</h3>
                <p>
    ...
    <div class="container content">
        <div class="row content">
            <div class="info col-lg-4 col-sm-12">
                <!-- alapelvek -->
                <h3 class="padding">Nyomtatás alapelvei</h3>
                <p>
            ...
            <div class="info col-lg-4 col-sm-12">
                <!-- szeletelő program -->
                <h3 class="padding">A szeletelő program</h3>
                <p>
            ...
            <div class="info col-lg-4 col-sm-4">
                <!-- nyomtatás -->
                <h3 class="padding">Nyomtatás</h3>
                <p>
        ...
        <div class="row content">
            <div class="info col-lg-5 col-sm-12">
                <!-- ipari nyomtatás -->
                <h3 class="padding">3D nyomtatás az iparban</h3>
                <p>
            ...
            <div class="info col-lg-7 col-sm-12">
                <!-- egészségügyben való nyomtatás -->
                <h3 class="padding">Nyomtatás az egészségügyben</h3>
                <p>
                    Orvosi eszközök:
                <ul>
                    <li>
                ...
                Az orvosképzésben, betegtájékoztatásban és műtétek előkészítésében használt 3D nyomtatott tárgyak
                világa ez.
                <ul>
                    <li>
                        Oktatási modellek
                    ...
                    <li>
                        Páncienssel való kommunikációt segítő modellek
                    </li>
                </ul>
                Még ha a laikusnak szinte sosem látható dolgokról is van itt szó, a beteg életét megmentő, műtéti
                ...
                Az orvosképzésben jelenleg használt sablonok általában magas beszerzési költségűek, gyakran probléma
                ...
                Ugyanakkor a részletgazdag, több színnel nyomtatott anatómiai bemutatódarabok gyártástechnológiailag
                adnak nagyon egyedi megoldást a kézzel fogható ábrázolásra.
                <br>
                <br>
                <b>Alkalmazott ergonómia:</b>
                <ul>
                    <li>
                        Implantátumok
                    </li>
                    ...
                    <li>
                        Egészség megőrzését szolgáló eszközök
                    </li>
                </ul>
                ...
                Természetesen nem lehet ezeket egymástól teljesen elkülöníteni, átfedések nem csak az eljárásokban,
                ...
                A képalkotó módszerek, a 3D szkennelés legalább olyan nagy jelentőségű technológiai fejlődésen megy
                keresztül, és természetesen a nyomtatással szorosan együttműködve kerülnek alkalmazásra.
                Mindkettő azon új digitális technológiákhoz tartozik, ami elősegíti a gyors prototípus gyártást és
                -fejlesztést, továbbá az egészségügy szempontjából különösen hasznos, hogy tulajdonságaikból adódóan
